...
public class PatrimonioResourceTest {
    ...
    public void testInsert() {
        ...
        bodyPatrimonio.put("localizacaoId", idLocalizacao);
        bodyPatrimonio.put("tipoPatrimonioId", idTipoPatrimonio);
        bodyPatrimonio.put("nome", atibuteValue);
    ...
    public void testListAll() {
        idPatrimonio = requisicao().when().get(PATH_PATRIMONIO).then().statusCode(Response.Status.OK.getStatusCode())
    ...
    public void testListAllPegeable() {
        final int page = 0;
        final int size = 5;
        requisicao().queryParam("page", page).queryParam("size", size).when().get(PATH_PATRIMONIO + "/page").then()
    ...
    public void testFindById() {
        requisicao().pathParam("id", idPatrimonio).when().get(PATH_PATRIMONIO + "/{id}").then()
    ...
    public void testUpdate() {
        Map<String, Object> body = bodyPatrimonio;
        body.put(atibuteValue, "nomeDiferente");
        requisicao().pathParam("id", idPatrimonio).body(body).when().put(PATH_PATRIMONIO + "/{id}").then()
    ...
    public void testDelete() {
        ...
        requisicao().when().get(PATH_PATRIMONIO).then().statusCode(Response.Status.OK.getStatusCode()).body("size()",
                CoreMatchers.is(0));
