...
public class DespesaResourceTest {
        ...
        private String insertTipoDespesa() {
                ...
                return requisicao().when().get(PATH_TIPODESPESA).then().statusCode(Response.Status.OK.getStatusCode())
        ...
        public void testDelete() {
                ...
                requisicao().when().get(PATH_DESPESA).then().statusCode(Response.Status.OK.getStatusCode())
