...
public class PagamentoPatrimonioResourceTest {
    ...
    private static final String PATH_PAGAMENTO = "/pagamento";
    private static final String PATH_PAGAMENTOPATRIMONIO = "/pagamentopatrimonio";
    ...
    private String idPagamentoPatrimonio;
    ...
    private HashMap<String, Object> bodyPagamento = new HashMap<String, Object>();
    private HashMap<String, Object> bodyPagamentoPatrimonio = new HashMap<String, Object>();

    private Double atibuteValue = 0.0;
    ...
    public void testSetUpLoad() {
        ...
        idDespesa = insertDespesa(idTipoDespesa, idPatrimonio);
        idPagamento = insertPagamento(idDespesa);
    }
    ...
    private String insertDespesa(String despesaTipoId, String patrimonioId) {
        bodyDespesa.put("dataFim", "06/04/2004");
        bodyDespesa.put("dataInicio", "06/04/2004");
        bodyDespesa.put("descricao", "descricao");
        bodyDespesa.put("obs", "obs");
        bodyDespesa.put("patrimonioId", patrimonioId);
        bodyDespesa.put("tipoDespesaId", despesaTipoId);
        ...
        return requisicao().when().get(PATH_DESPESA).then().statusCode(Response.Status.OK.getStatusCode()).extract()
                .jsonPath().get("[0].id");
    }

    private String insertPagamento(String despesaId) {
        bodyPagamento.put("dataPagamento", "06/04/2020");
        bodyPagamento.put("despesaId", idDespesa);
        bodyPagamento.put("obs", "obs");
        bodyPagamento.put("valor", 0);

        requisicao().body(bodyPagamento).when().post(PATH_PAGAMENTO).then()
                .statusCode(Response.Status.CREATED.getStatusCode()).header("location", CoreMatchers.notNullValue());

        return requisicao().when().get(PATH_PAGAMENTO).then().statusCode(Response.Status.OK.getStatusCode()).extract()
                .jsonPath().get("[0].id");
    }
    ...
    public void testInsert() {
        bodyPagamentoPatrimonio.put("pagamentoId", idPagamento);
        bodyPagamentoPatrimonio.put("patrimonioId", idPatrimonio);
        bodyPagamentoPatrimonio.put("valorCalculado", atibuteValue);

        requisicao().body(bodyPagamentoPatrimonio).when().post(PATH_PAGAMENTOPATRIMONIO).then()
                .statusCode(Response.Status.CREATED.getStatusCode()).header("location", CoreMatchers.notNullValue());
    }
    ...
    public void testListAll() {
        idPagamentoPatrimonio = requisicao().when().get(PATH_PAGAMENTOPATRIMONIO).then()
    ...
    public void testListAllPegeable() {
        final int page = 0;
        final int size = 5;
        requisicao().queryParam("page", page).queryParam("size", size).when().get(PATH_PAGAMENTOPATRIMONIO + "/page")
    ...
    public void testFindById() {
        requisicao().pathParam("id", idPagamentoPatrimonio).when().get(PATH_PAGAMENTOPATRIMONIO + "/{id}").then()
    ...
    public void testUpdate() {
        Map<String, Object> body = bodyPagamentoPatrimonio;
        body.put("valorCalculado", 5);
        requisicao().pathParam("id", idPagamentoPatrimonio).body(body).when().put(PATH_PAGAMENTOPATRIMONIO + "/{id}")
    ...
    public void testDelete() {
        requisicao().pathParam("id", idPagamentoPatrimonio).when().delete(PATH_PAGAMENTOPATRIMONIO + "/{id}").then()
                .statusCode(Response.Status.NO_CONTENT.getStatusCode());

        requisicao().when().get(PATH_PAGAMENTOPATRIMONIO).then().statusCode(Response.Status.OK.getStatusCode())
    ...
    public void testCleanUp() {
        ...
        requisicao().pathParam("id", idPagamento).when().delete(PATH_PAGAMENTO + "/{id}").then()
                .statusCode(Response.Status.NO_CONTENT.getStatusCode());
