...
public class PagamentoResourceTest {
    ...
    private String atibuteValue = "obs";
    ...
    public void testInsert() {
        ...
        bodyPagamento.put("obs", atibuteValue);
    ...
    public void testListAll() {
        idPagamento = requisicao().when().get(PATH_PAGAMENTO).then().statusCode(Response.Status.OK.getStatusCode())
    ...
    public void testListAllPegeable() {
        final int page = 0;
        final int size = 5;
        requisicao().queryParam("page", page).queryParam("size", size).when().get(PATH_PAGAMENTO + "/page").then()
    ...
    public void testFindById() {
        requisicao().pathParam("id", idPagamento).when().get(PATH_PAGAMENTO + "/{id}").then()
    ...
    public void testUpdate() {
        Map<String, Object> body = bodyPagamento;
        body.put(atibuteValue, "nomeDiferente");
        requisicao().pathParam("id", idPagamento).body(body).when().put(PATH_PAGAMENTO + "/{id}").then()
    ...
    public void testDelete() {
        ...
        requisicao().when().get(PATH_PAGAMENTO).then().statusCode(Response.Status.OK.getStatusCode()).body("size()",
                CoreMatchers.is(0));
