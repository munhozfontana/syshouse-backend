...
public class RecebimentoResourceTest {
    ...
    private HashMap<String, Object> bodyTipoRecebimento = new HashMap<String, Object>();
    ...
    private HashMap<String, Object> bodyRecebimento = new HashMap<String, Object>();
    ...
    private String insertRenda(String pagadorId, String patrimonioId, String tiporendaId) {
    ...
    public void testInsert() {
        ...
        bodyRecebimento.put("obs", atibuteValue);
        bodyRecebimento.put("rendaId", idRenda);
    ...
    public void testListAll() {
        idRecebimento = requisicao().when().get(PATH_RECEBIMENTO).then().statusCode(Response.Status.OK.getStatusCode())
    ...
    public void testListAllPegeable() {
        final int page = 0;
        final int size = 5;
        requisicao().queryParam("page", page).queryParam("size", size).when().get(PATH_RECEBIMENTO + "/page").then()
    ...
    public void testFindById() {
        requisicao().pathParam("id", idRecebimento).when().get(PATH_RECEBIMENTO + "/{id}").then()
    ...
    public void testUpdate() {
        Map<String, Object> body = bodyRecebimento;
        body.put(atibuteValue, "novoDadoDiferente");
        requisicao().pathParam("id", idRecebimento).body(body).when().put(PATH_RECEBIMENTO + "/{id}").then()
    ...
    public void testDelete() {
        ...
        requisicao().when().get(PATH_RECEBIMENTO).then().statusCode(Response.Status.OK.getStatusCode()).body("size()",
                CoreMatchers.is(0));
