...
public class MovimentacaoResource {
    ...
    @GET
    @Path("{id}")
    @Operation(summary = "Movimentacao pelo ID", description = "Atravez do ID da entidade Movimentacao é retornado apenas um objeto do mesmo")
    ...
    @GET
    @Operation(summary = "Lista de Movimentacao", description = "É retornado uma lista de objetos Movimentacao")
    ...
    public Response insert(final @RequestBody @Valid MovimentacaoNewDTO dto) throws URISyntaxException {
        ...
        entidade.setId(id);
        return Response.created(new URI("movimentacao/" + id.toString())).entity(entidade).build();
    }
    ...
    @DELETE
    @Path("{id}")
    @Operation(summary = "Remove Movimentacao", description = "Remove o objeto Movimentacao passando o ID do mesmo")
