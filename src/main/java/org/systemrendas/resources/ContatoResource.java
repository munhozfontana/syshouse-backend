...
public class ContatoResource {
    ...
    public Response listAllPage(@QueryParam Integer page, @QueryParam Integer size) {
        Pagination<ContatoDTO> pages = service.findAllPage(page, size);
    ...
    public Response insert(final @RequestBody @Valid ContatoNewDTO dto) throws URISyntaxException {
        ...
        entidade.setId(id);
        return Response.created(new URI("contato/" + id.toString())).entity(entidade).build();
    }
